...
const TrainingPaymentAttemptSchema = new mongoose_1.Schema({
    ...
    skillCourseId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'SkillCourse' },
...
exports.default = mongoose_1.default.model('TrainingPaymentAttempt', TrainingPaymentAttemptSchema);
