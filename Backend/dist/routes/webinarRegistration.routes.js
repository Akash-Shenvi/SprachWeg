...
router.post('/verify-payment', auth_middleware_1.isAuth, webinarRegistration_controller_1.verifyWebinarPayment);
router.post('/payment-failure', auth_middleware_1.isAuth, webinarRegistration_controller_1.recordWebinarPaymentFailure);
