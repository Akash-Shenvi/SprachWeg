...
const seedDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/sprachweg');
        console.log('Connected to MongoDB');
        // Clear existing Language courses
        yield languageCourse_model_1.default.deleteMany({ title: { $in: languageCourses.map(c => c.title) } });
        console.log('Cleared existing language courses');
        // Insert Language courses
        yield languageCourse_model_1.default.insertMany(languageCourses);
        ...
        yield skillCourse_model_1.default.deleteMany({ category: 'Language' });
        ...
        if (skillCourses.length > 0) {
            yield skillCourse_model_1.default.deleteMany({ title: { $in: skillCourses.map(c => c.title) } });
            yield skillCourse_model_1.default.insertMany(skillCourses);
