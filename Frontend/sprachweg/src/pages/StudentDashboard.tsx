...
const getChatButtonClasses = (hasUnread: boolean) => (
    hasUnread
        ? 'relative flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[#d6b161]/30 bg-[#d6b161] text-[#0a192f] shadow-sm transition-colors hover:bg-[#cfaa5b]'
        : 'relative flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#d6b161]/10 text-[#d6b161] transition-colors hover:bg-[#d6b161]/20'
);
            ...
            <div className="relative">
                ...
                <div className="mt-5 flex gap-3" onClick={(e) => e.stopPropagation()}>
                    ...
                    {trainerId && (
                        ...
                        >
                            {hasUnreadChat && (
                                <span className="absolute -right-0.5 -top-0.5 h-3 w-3 rounded-full bg-[#0a192f] ring-2 ring-white dark:ring-gray-800" />
                            )}
