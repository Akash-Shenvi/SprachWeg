...
import { Check, ChevronRight, Clock, Target, Award, Users, BookOpen, Factory } from 'lucide-react';
...
const AdvancedIndustry4Page: React.FC = () => {
    const [isEnrollModalOpen, setIsEnrollModalOpen] = useState(false);
    const shouldReduceMotion = useReducedMotion();

    const whyChooseFeatures = [
        "Learn Industry 4.0 technologies including IIoT, AI, and machine learning applications",
        "Hands-on projects for implementing smart factory concepts",
        "Flexible training modes: Online, Offline, or Hybrid",
        "Certification and guidance for career advancement",
        "Gain skills to drive digital transformation and improve operational efficiency"
    ];
                    ...
                    >
                        <motion.div variants={fadeInUp} className="mb-8 flex justify-center">
                            <span className="inline-flex items-center gap-2 rounded-full border border-[#d6b161]/20 bg-[#d6b161]/10 px-4 py-1.5 text-sm font-semibold text-[#d6b161] backdrop-blur-sm">
                                <Factory className="h-4 w-4 fill-current" />
                        ...
                        >
                            Advanced Automation <br className="hidden sm:inline" />
                            <span className="bg-gradient-to-r from-[#d6b161] to-[#b38f3f] bg-clip-text text-transparent">Industry 4.0</span>
                        </motion.h1>
                        ...
                        >
                            At Sovir Technologies, our Industry 4.0 training empowers candidates to master the integration of cutting-edge technologies such as IIoT, AI, machine learning, smart sensors, and data analytics into modern industrial environments. This course prepares learners to lead the digital transformation of manufacturing and process industries.
                        </motion.p>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        >
                            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-200">
                                The Advanced Automation Industry 4.0 course covers the core concepts and practical applications of smart factories, cyber-physical systems, IoT-enabled production lines, and predictive maintenance. Candidates will learn to optimize production using real-time data, advanced automation strategies, and connected devices, making them valuable assets for modern industries.
                            </p>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            >
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">50 hours (6 weeks)</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">Tue, Thu, Sat - 6 PM to 9 PM</p>
                            </motion.div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        >
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-200">
                                    Suitable for engineers, automation professionals, managers, and anyone interested in implementing smart and data-driven industrial processes.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="mx-auto max-w-5xl">
                        ...
                        >
                            <div className="relative z-10">
                                <Factory className="mx-auto mb-6 h-12 w-12 text-[#d6b161]" />
                                <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
                                    Lead the Industry 4.0 Revolution
                                </h2>
                                <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-300">
                                    Join Sovir Technologies and drive digital transformation in manufacturing.
                                </p>
                                <motion.button
                            ...
                            <div className="absolute bottom-0 left-0 -mb-10 -ml-10 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl"></div>
                        </motion.div>
                    </div>
                </section>
            </main>
...
export default AdvancedIndustry4Page;
