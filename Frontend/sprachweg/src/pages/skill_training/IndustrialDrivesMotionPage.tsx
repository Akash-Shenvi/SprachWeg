                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            >
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">45 hours (5 weeks)</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">₹10200 to ₹18800</p>
                            </motion.div>
                        </div>
                    </div>
                </section>
