...
import { Check, ChevronRight, Clock, Target, Award, Users, BookOpen, Cpu } from 'lucide-react';
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="absolute -top-[10%] -right-[10%] h-[600px] w-[600px] rounded-full bg-gradient-to-br from-[#d6b161]/20 to-emerald-500/10 blur-[120px]"
            />
            <motion.div
                style={{ y: y2 }}
                animate={{
                ...
                className="absolute top-[20%] -left-[10%] h-[500px] w-[500px] rounded-full bg-blue-500/10 blur-[100px]"
            />
...
const PLCIndustrialAutomationPage: React.FC = () => {
    const [isEnrollModalOpen, setIsEnrollModalOpen] = useState(false);
    const shouldReduceMotion = useReducedMotion();

    const whyChooseFeatures = [
        "Hands-on training with real PLC hardware and simulation tools",
        "Learn industrial protocols and advanced automation techniques",
        "Flexible learning options to suit working professionals",
        "Guidance for industrial project implementation and certification",
        "Industry-aligned curriculum to enhance employability"
    ];
                    ...
                    >
                        <motion.div variants={fadeInUp} className="mb-8 flex justify-center">
                            <span className="inline-flex items-center gap-2 rounded-full border border-[#d6b161]/20 bg-[#d6b161]/10 px-4 py-1.5 text-sm font-semibold text-[#d6b161] backdrop-blur-sm">
                                <Cpu className="h-4 w-4 fill-current" />
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        >
                            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-200">
                                This course covers PLC programming fundamentals, ladder logic, industrial communication protocols, sensors & actuators integration, and automation project implementation. Candidates will learn how to design and troubleshoot PLC-based control systems for various industries, enhancing both their technical and problem-solving skills.
                            </p>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            >
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">56 hours (7 weeks)</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-xl font-bold text-gray-900 dark:text-white">₹9200 to ₹17800</p>
                            </motion.div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        >
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-200">
                                    Engineering students, technicians, automation professionals, and anyone looking to master PLC systems and industrial automation.
                                </p>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="mx-auto max-w-5xl">
                        ...
                        >
                            <div className="relative z-10">
                                <Cpu className="mx-auto mb-6 h-12 w-12 text-[#d6b161]" />
                                <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
                                    Ready to Master PLC & Industrial Automation?
                                </h2>
                                <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-300">
                                    Join Sovir Technologies and become an expert in industrial control systems.
                                </p>
                                <motion.button
                            ...
                            <div className="absolute bottom-0 left-0 -mb-10 -ml-10 h-64 w-64 rounded-full bg-emerald-500/10 blur-3xl"></div>
                        </motion.div>
                    </div>
                </section>
            </main>
...
export default PLCIndustrialAutomationPage;
