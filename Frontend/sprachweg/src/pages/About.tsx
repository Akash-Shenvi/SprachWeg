    ...
    <ul className="space-y-3">
        {items.map((item, index) => (
            <li key={index} className="flex items-start gap-3">
                <span className="mt-1.5 min-w-[6px] min-h-[6px] rounded-full bg-[#d6b161] flex-shrink-0" aria-hidden="true" />
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch">
                            ...
                            <div className="relative h-full flex flex-col">
                                ...
                                <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 relative z-10 flex-1 flex flex-col justify-center">
                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="grid grid-cols-1 gap-8 md:gap-10 items-stretch">
                            ...
                            <motion.section
                                ...
                                viewport={{ once: true }}
                                variants={sectionVariants}
                                className="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-700 h-full flex flex-col"
                                ...
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        <li key={i} className="flex items-start gap-4 p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-colors border border-white/5">
                                            <span className="text-[#d6b161] mt-1 flex-shrink-0" aria-hidden="true">
                                                <Icons.Check />
                                            </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="h-full flex flex-col items-center text-center p-6 sm:p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow"
                                >
