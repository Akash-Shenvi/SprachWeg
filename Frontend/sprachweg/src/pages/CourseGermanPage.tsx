...
const CourseLevelCard: React.FC<CourseLevelCardProps> = ({ level, index, onEnroll }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 h-1.5 w-full bg-gradient-to-r from-red-600 via-[#d6b161] to-[#0a192f]" />

      <div className="flex flex-1 flex-col p-8">
        {/* Header */}
        <div className="mb-6 flex items-start justify-between">
          <div className="inline-flex items-center gap-2 rounded-full bg-red-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-red-900 dark:bg-red-900/30 dark:text-red-100">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">Complete {level.name} certification</p>
        </div>
        ...
        <div className="mb-8 rounded-xl bg-gray-50 p-4 ring-1 ring-gray-100 dark:bg-gray-900/50 dark:ring-gray-800">
          <p className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Expected Outcome</p>
...
const faqs = [
  {
    ...
    answer: 'Yes. Our curriculum is aligned with CEFR and prepares you for official exams.'
  },
  {
    id: '2',
    question: 'Do I need prior knowledge?',
    answer: 'No. Our beginner levels are designed for complete beginners.'
  },
  {
    id: '3',
    question: 'What certification will I receive?',
    answer: 'Upon completion, you receive a certificate aligned with international standards.'
  }
];
      ...
      <section className="relative py-28 sm:py-36 text-center overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Master German for <br className="hidden sm:inline" />
              <span className="bg-gradient-to-r from-[#d6b161] to-[#b38f3f] bg-clip-text text-transparent">Your Career</span>
            </motion.h1>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
                From beginner A1 to expert C2, find the perfect fit.
              </p>
            </motion.div>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            >
              <div className="relative z-10">
                <Globe className="mx-auto mb-6 h-12 w-12 text-[#d6b161]" />
                <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
                  Start Speaking German Today
                </h2>
                <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-300">
                  Open doors to new career opportunities in German-speaking countries.
                </p>
                {/* Note: "View Level" button removed */}
              </div>

              {/* Background Accents - German Flag Colors subtle hint */}
              <div className="absolute top-0 right-0 -mt-10 -mr-10 h-64 w-64 rounded-full bg-[#d6b161]/10 blur-3xl"></div>
              <div className="absolute bottom-0 left-0 -mb-10 -ml-10 h-64 w-64 rounded-full bg-red-500/10 blur-3xl"></div>
            </motion.div>
          </div>
        </section>
      </main>
