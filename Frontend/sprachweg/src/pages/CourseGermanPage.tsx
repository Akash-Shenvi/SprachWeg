...
const germanExtendedData: ExtendedCourseData = {
  contextualFit: {
    targetAudience: 'Students aiming for German universities, Job Seekers (Blue Card), and Expats.',
    typicalNextSteps: 'TestDaF / DSH Exam, Job Application Training, C1 Advanced German.',
    careerRoles: 'Engineer in Germany, Medical Professional, IT Specialist (German-speaking).',
  },
  relatedCourses: [
    { title: 'Living in Germany', level: 'Beginner', description: 'Cultural integration guide', slug: '/courses/living-in-germany' },
    { title: 'Business German', level: 'B2+', description: 'Workplace communication', slug: '/courses/business-german' },
    { title: 'TestDaF Prep', level: 'Adavnced', description: 'University admission focus', slug: '/courses/testdaf' },
    { title: 'English for Business', level: 'B2', description: 'Global communication', slug: '/courses/english' },
  ],
  certification: {
    title: 'Goethe-Zertifikat Readiness',
    outcomes: [
      'Aligned with CEFR Levels',
      'Accepted by German Embassies',
      'Valid for University Applications',
    ],
  },
  skillsTools: ['Visa Interview Prep', 'Technical Vocabulary', 'Email in German', 'Daily Conversation', 'Grammar Precision', 'Pronunciation Coaching'],
  timeCommitment: {
...
const CourseGermanPage: React.FC = () => {
  ...
  const course = { ...germanCourseData, ...germanExtendedData };
