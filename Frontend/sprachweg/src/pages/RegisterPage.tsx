...
import { Mail, Lock, Eye, EyeOff, CheckCircle, Phone } from 'lucide-react';
...
const RegisterPage: React.FC = () => {
    ...
    return (
        <>
            <Header />
            <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900 pt-20">
                {/* Left Panel */}
                            ...
                            {step === 'register' ? (
                                ...
                                >
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                placeholder="John"
                                                className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-gray-900 placeholder:text-gray-400 transition-all focus:outline-none focus:ring-2 focus:ring-[#0e5cad] focus:border-transparent dark:bg-gray-800 dark:border-gray-700 dark:text-white"
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input type="checkbox" id="terms" required className="rounded border-gray-300 text-[#0e5cad] focus:ring-[#0e5cad]" />
                                        <label htmlFor="terms" className="text-sm text-gray-600 dark:text-gray-400">
                                            I agree to the <a href="#" className="text-[#0e5cad] font-medium">Terms of Service</a> and <a href="#" className="text-[#0e5cad] font-medium">Privacy Policy</a>
                                        </label>
                                    </div>
                                    ...
                                    <div className="mt-6">
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 bg-white dark:bg-gray-800 transition-colors"
                                        >
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 text-gray-900 placeholder:text-gray-400 transition-all focus:outline-none focus:ring-2 focus:ring-[#0e5cad] focus:border-transparent dark:bg-gray-800 dark:border-gray-700 dark:text-white text-center tracking-widest text-lg"
                                            value={formData.otp}
